    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black text-gray-900 dark:text-white">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-white dark:bg-[#0b0f1a] border border-gray-200 dark:border-gray-800 shadow-2xl animate-cardIn">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Tạo tài khoản mới</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Tên đăng nhập */}
          <div>
            <label className="text-sm text-gray-700 dark:text-gray-300">Tên đăng nhập</label>
            <input
              type="text"
              value={username}
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-500 mt-1">Tối thiểu 6 ký tự</p>
          </div>
